...
function plugin_basename( $file ) {
	...
	$plugin_dir    = defined( 'WP_PLUGIN_DIR' ) ? wp_normalize_path( WP_PLUGIN_DIR ) : ( defined( 'WP_CONTENT_DIR' ) ? wp_normalize_path( WP_CONTENT_DIR . '/plugins' ) : '' );
	$mu_plugin_dir = defined( 'WPMU_PLUGIN_DIR' ) ? wp_normalize_path( WPMU_PLUGIN_DIR ) : ( defined( 'WP_CONTENT_DIR' ) ? wp_normalize_path( WP_CONTENT_DIR . '/mu-plugins' ) : '' );
