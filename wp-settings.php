...
// AstraeaOS WP: Core Ignition & Security Foundation
if ( file_exists( ABSPATH . 'astraea-core/astraea-bootstrap.php' ) ) {
	require_once ABSPATH . 'astraea-core/astraea-bootstrap.php';
}
